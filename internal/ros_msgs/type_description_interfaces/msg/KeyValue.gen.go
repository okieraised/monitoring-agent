...
func init() {
	typemap.RegisterMessage("type_description_interfaces/KeyValue", KeyValueTypeSupport)
	typemap.RegisterMessage("type_description_interfaces/msg/KeyValue", KeyValueTypeSupport)
}
...
// KeyValue
func NewKeyValuePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*KeyValuePublisher, error) {
...
// KeyValue
func NewKeyValueSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback KeyValueSubscriptionCallback) (*KeyValueSubscription, error) {
...
func (t _KeyValueTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.type_description_interfaces__msg__KeyValue
	return (unsafe.Pointer)(C.type_description_interfaces__msg__KeyValue__create())
}

func (t _KeyValueTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.type_description_interfaces__msg__KeyValue__destroy((*C.type_description_interfaces__msg__KeyValue)(pointer_to_free))
}

func (t _KeyValueTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*KeyValue)
	mem := (*C.type_description_interfaces__msg__KeyValue)(dst)
...
func (t _KeyValueTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*KeyValue)
	mem := (*C.type_description_interfaces__msg__KeyValue)(ros2_message_buffer)
...
func (t _KeyValueTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__type_description_interfaces__msg__KeyValue())
}

type CKeyValue = C.type_description_interfaces__msg__KeyValue
type CKeyValueSequence = C.type_description_interfaces__msg__KeyValue__Sequence
...
func KeyValueSequenceToC(cSlice *CKeyValueSequence, goSlice []KeyValue) {
	...
	cSlice.data = (*C.type_description_interfaces__msg__KeyValue)(C.malloc(C.sizeof_struct_type_description_interfaces__msg__KeyValue * C.size_t(len(goSlice))))
