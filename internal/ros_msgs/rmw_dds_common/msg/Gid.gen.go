...
// Gid
func NewGidPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GidPublisher, error) {
...
// Gid
func NewGidSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GidSubscriptionCallback) (*GidSubscription, error) {
...
func (t _GidTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.CharArrayToC(*(*[]primitives.CChar)(unsafe.Pointer(&cSlice_data)), m.Data[:])
}
...
func (t _GidTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_data := mem.data[:]
	primitives.CharArrayToGo(m.Data[:], *(*[]primitives.CChar)(unsafe.Pointer(&cSlice_data)))
}
