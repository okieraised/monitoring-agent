...
// GoalID
func NewGoalIDPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GoalIDPublisher, error) {
...
// GoalID
func NewGoalIDSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GoalIDSubscriptionCallback) (*GoalIDSubscription, error) {
