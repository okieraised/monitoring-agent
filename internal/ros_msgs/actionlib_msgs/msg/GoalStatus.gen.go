...
// GoalStatus
func NewGoalStatusPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GoalStatusPublisher, error) {
...
// GoalStatus
func NewGoalStatusSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GoalStatusSubscriptionCallback) (*GoalStatusSubscription, error) {
...
type CGoalStatusSequence = C.actionlib_msgs__msg__GoalStatus__Sequence
