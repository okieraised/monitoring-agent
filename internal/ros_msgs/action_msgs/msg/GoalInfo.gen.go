...
// GoalInfo
func NewGoalInfoPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GoalInfoPublisher, error) {
...
// GoalInfo
func NewGoalInfoSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GoalInfoSubscriptionCallback) (*GoalInfoSubscription, error) {
