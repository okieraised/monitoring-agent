...
// CancelGoal_Response
func NewCancelGoal_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*CancelGoal_ResponsePublisher, error) {
	pub, err := node.NewPublisher(topicName, CancelGoal_ResponseTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// CancelGoal_Response
func NewCancelGoal_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback CancelGoal_ResponseSubscriptionCallback) (*CancelGoal_ResponseSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg CancelGoal_Response
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, CancelGoal_ResponseTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (t _CancelGoal_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	action_msgs_msg.GoalInfoSequenceToC((*action_msgs_msg.CGoalInfoSequence)(unsafe.Pointer(&mem.goals_canceling)), m.GoalsCanceling)
}
...
func (t _CancelGoal_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	action_msgs_msg.GoalInfoSequenceToGo(&m.GoalsCanceling, *(*action_msgs_msg.CGoalInfoSequence)(unsafe.Pointer(&mem.goals_canceling)))
}
...
type CCancelGoal_ResponseSequence = C.action_msgs__srv__CancelGoal_Response__Sequence

func CancelGoal_ResponseSequenceToGo(goSlice *[]CancelGoal_Response, cSlice CCancelGoal_ResponseSequence) {
	if cSlice.size == 0 {
		return
	}
...
func CancelGoal_ResponseSequenceToC(cSlice *CCancelGoal_ResponseSequence, goSlice []CancelGoal_Response) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func CancelGoal_ResponseArrayToGo(goSlice []CancelGoal_Response, cSlice []CCancelGoal_Response) {
	for i := 0; i < len(cSlice); i++ {
		CancelGoal_ResponseTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func CancelGoal_ResponseArrayToC(cSlice []CCancelGoal_Response, goSlice []CancelGoal_Response) {
