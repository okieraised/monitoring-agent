...
// Duration
func NewDurationPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*DurationPublisher, error) {
...
// Duration
func NewDurationSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback DurationSubscriptionCallback) (*DurationSubscription, error) {
