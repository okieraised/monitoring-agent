...
// Time
func NewTimePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TimePublisher, error) {
...
// Time
func NewTimeSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TimeSubscriptionCallback) (*TimeSubscription, error) {
