...
// Trigger_Response
func NewTrigger_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Trigger_ResponsePublisher, error) {
...
// Trigger_Response
func NewTrigger_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Trigger_ResponseSubscriptionCallback) (*Trigger_ResponseSubscription, error) {
