...
// Empty_Response
func NewEmpty_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Empty_ResponsePublisher, error) {
...
// Empty_Response
func NewEmpty_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Empty_ResponseSubscriptionCallback) (*Empty_ResponseSubscription, error) {
