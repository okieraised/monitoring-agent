...
func init() {
	<no value>.RegisterService("std_srvs/SetBool", SetBoolTypeSupport)
	<no value>.RegisterService("std_srvs/srv/SetBool", SetBoolTypeSupport)
}

type _SetBoolTypeSupport struct {}

func (s _SetBoolTypeSupport) Request() <no value>.MessageTypeSupport {
	return SetBool_RequestTypeSupport
}

func (s _SetBoolTypeSupport) Response() <no value>.MessageTypeSupport {
...
var SetBoolTypeSupport <no value>.ServiceTypeSupport = _SetBoolTypeSupport{}

// SetBoolClient wraps <no value>.Client to provide type safe helper
// functions
...
// SetBool
func NewSetBoolClient(node *<no value>.Node, serviceName string, options *<no value>.ClientOptions) (*SetBoolClient, error) {
...
func (s *SetBoolClient) Send(ctx context.Context, req *SetBool_Request) (*SetBool_Response, *<no value>.ServiceInfo, error) {
...
type SetBoolServiceRequestHandler func(*<no value>.ServiceInfo, *SetBool_Request, SetBoolServiceResponseSender)

// SetBoolService wraps <no value>.Service to provide type safe helper
// functions
...
// SetBool
func NewSetBoolService(node *<no value>.Node, name string, options *<no value>.ServiceOptions, handler SetBoolServiceRequestHandler) (*SetBoolService, error) {
