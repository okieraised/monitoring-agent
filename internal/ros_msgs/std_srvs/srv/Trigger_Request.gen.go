...
// Trigger_Request
func NewTrigger_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Trigger_RequestPublisher, error) {
...
// Trigger_Request
func NewTrigger_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Trigger_RequestSubscriptionCallback) (*Trigger_RequestSubscription, error) {
