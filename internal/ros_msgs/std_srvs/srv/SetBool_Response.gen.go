...
// SetBool_Response
func NewSetBool_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetBool_ResponsePublisher, error) {
...
// SetBool_Response
func NewSetBool_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetBool_ResponseSubscriptionCallback) (*SetBool_ResponseSubscription, error) {
