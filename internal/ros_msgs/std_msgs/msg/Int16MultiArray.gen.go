...
func init() {
	...
	typemap.RegisterMessage("std_msgs/msg/Int16MultiArray", Int16MultiArrayTypeSupport)
}
...
// Int16MultiArray
func NewInt16MultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Int16MultiArrayPublisher, error) {
...
// Int16MultiArray
func NewInt16MultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int16MultiArraySubscriptionCallback) (*Int16MultiArraySubscription, error) {
...
func (t _Int16MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Int16SequenceToC((*primitives.CInt16Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _Int16MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Int16SequenceToGo(&m.Data, *(*primitives.CInt16Sequence)(unsafe.Pointer(&mem.data)))
}
