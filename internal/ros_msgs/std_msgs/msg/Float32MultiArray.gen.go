...
// Float32MultiArray
func NewFloat32MultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Float32MultiArrayPublisher, error) {
...
// Float32MultiArray
func NewFloat32MultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Float32MultiArraySubscriptionCallback) (*Float32MultiArraySubscription, error) {
...
func (t _Float32MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float32SequenceToC((*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _Float32MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float32SequenceToGo(&m.Data, *(*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.data)))
}
