...
// ByteMultiArray
func NewByteMultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ByteMultiArrayPublisher, error) {
...
// ByteMultiArray
func NewByteMultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ByteMultiArraySubscriptionCallback) (*ByteMultiArraySubscription, error) {
...
func (t _ByteMultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.ByteSequenceToC((*primitives.CByteSequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _ByteMultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.ByteSequenceToGo(&m.Data, *(*primitives.CByteSequence)(unsafe.Pointer(&mem.data)))
}
