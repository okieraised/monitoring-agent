...
// Int8
func NewInt8Publisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Int8Publisher, error) {
	pub, err := node.NewPublisher(topicName, Int8TypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// Int8
func NewInt8Subscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int8SubscriptionCallback) (*Int8Subscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg Int8
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, Int8TypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
type CInt8Sequence = C.std_msgs__msg__Int8__Sequence
