...
// Bool
func NewBoolPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*BoolPublisher, error) {
...
// Bool
func NewBoolSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback BoolSubscriptionCallback) (*BoolSubscription, error) {
