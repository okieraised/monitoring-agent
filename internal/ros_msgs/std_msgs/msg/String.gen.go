...
// String
func NewStringPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*StringPublisher, error) {
...
// String
func NewStringSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback StringSubscriptionCallback) (*StringSubscription, error) {
