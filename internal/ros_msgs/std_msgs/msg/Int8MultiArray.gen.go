...
// Int8MultiArray
func NewInt8MultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Int8MultiArrayPublisher, error) {
...
// Int8MultiArray
func NewInt8MultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int8MultiArraySubscriptionCallback) (*Int8MultiArraySubscription, error) {
