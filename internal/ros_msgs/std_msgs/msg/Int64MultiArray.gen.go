...
// Int64MultiArray
func NewInt64MultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Int64MultiArrayPublisher, error) {
...
// Int64MultiArray
func NewInt64MultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int64MultiArraySubscriptionCallback) (*Int64MultiArraySubscription, error) {
...
func (t _Int64MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Int64SequenceToC((*primitives.CInt64Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _Int64MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Int64SequenceToGo(&m.Data, *(*primitives.CInt64Sequence)(unsafe.Pointer(&mem.data)))
}
