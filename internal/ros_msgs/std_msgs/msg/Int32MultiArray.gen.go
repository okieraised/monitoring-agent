...
func init() {
	...
	typemap.RegisterMessage("std_msgs/msg/Int32MultiArray", Int32MultiArrayTypeSupport)
}
...
// Int32MultiArrayPublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
// Int32MultiArray
func NewInt32MultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Int32MultiArrayPublisher, error) {
...
// Int32MultiArraySubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
// Int32MultiArray
func NewInt32MultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int32MultiArraySubscriptionCallback) (*Int32MultiArraySubscription, error) {
...
func (t _Int32MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Int32SequenceToC((*primitives.CInt32Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _Int32MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Int32SequenceToGo(&m.Data, *(*primitives.CInt32Sequence)(unsafe.Pointer(&mem.data)))
}
