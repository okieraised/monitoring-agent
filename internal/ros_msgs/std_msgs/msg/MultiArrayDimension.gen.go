...
// MultiArrayDimension
func NewMultiArrayDimensionPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MultiArrayDimensionPublisher, error) {
...
// MultiArrayDimension
func NewMultiArrayDimensionSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MultiArrayDimensionSubscriptionCallback) (*MultiArrayDimensionSubscription, error) {
