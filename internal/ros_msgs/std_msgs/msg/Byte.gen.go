...
// Byte
func NewBytePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*BytePublisher, error) {
...
// Byte
func NewByteSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ByteSubscriptionCallback) (*ByteSubscription, error) {
