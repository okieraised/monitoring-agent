...
// Header
func NewHeaderPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*HeaderPublisher, error) {
...
// Header
func NewHeaderSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback HeaderSubscriptionCallback) (*HeaderSubscription, error) {
