...
// Int64
func NewInt64Publisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Int64Publisher, error) {
...
// Int64
func NewInt64Subscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Int64SubscriptionCallback) (*Int64Subscription, error) {
