...
// Empty
func NewEmptyPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*EmptyPublisher, error) {
...
// Empty
func NewEmptySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback EmptySubscriptionCallback) (*EmptySubscription, error) {
