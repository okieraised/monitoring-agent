...
// MultiArrayLayout
func NewMultiArrayLayoutPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MultiArrayLayoutPublisher, error) {
...
// MultiArrayLayout
func NewMultiArrayLayoutSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MultiArrayLayoutSubscriptionCallback) (*MultiArrayLayoutSubscription, error) {
