...
// Float64MultiArray
func NewFloat64MultiArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Float64MultiArrayPublisher, error) {
...
// Float64MultiArray
func NewFloat64MultiArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Float64MultiArraySubscriptionCallback) (*Float64MultiArraySubscription, error) {
...
func (t _Float64MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.data)), m.Data)
}
...
func (t _Float64MultiArrayTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float64SequenceToGo(&m.Data, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.data)))
}
