...
// Float32
func NewFloat32Publisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Float32Publisher, error) {
...
// Float32
func NewFloat32Subscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Float32SubscriptionCallback) (*Float32Subscription, error) {
