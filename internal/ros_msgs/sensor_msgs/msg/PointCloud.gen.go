...
// PointCloud
func NewPointCloudPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PointCloudPublisher, error) {
...
// PointCloud
func NewPointCloudSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PointCloudSubscriptionCallback) (*PointCloudSubscription, error) {
