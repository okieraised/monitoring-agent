...
// LaserEcho
func NewLaserEchoPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LaserEchoPublisher, error) {
...
// LaserEcho
func NewLaserEchoSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LaserEchoSubscriptionCallback) (*LaserEchoSubscription, error) {
...
func (t _LaserEchoTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float32SequenceToC((*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.echoes)), m.Echoes)
}
...
func (t _LaserEchoTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float32SequenceToGo(&m.Echoes, *(*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.echoes)))
}
