...
// ChannelFloat32
func NewChannelFloat32Publisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ChannelFloat32Publisher, error) {
...
// ChannelFloat32
func NewChannelFloat32Subscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ChannelFloat32SubscriptionCallback) (*ChannelFloat32Subscription, error) {
...
func (t _ChannelFloat32TypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float32SequenceToC((*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.values)), m.Values)
}
...
func (t _ChannelFloat32TypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float32SequenceToGo(&m.Values, *(*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.values)))
}
