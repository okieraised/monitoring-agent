...
// FluidPressure
func NewFluidPressurePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*FluidPressurePublisher, error) {
...
// FluidPressure
func NewFluidPressureSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback FluidPressureSubscriptionCallback) (*FluidPressureSubscription, error) {
