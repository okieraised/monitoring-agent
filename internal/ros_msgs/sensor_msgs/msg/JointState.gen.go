...
// JointState
func NewJointStatePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*JointStatePublisher, error) {
...
// JointState
func NewJointStateSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback JointStateSubscriptionCallback) (*JointStateSubscription, error) {
...
func (t _JointStateTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.StringSequenceToC((*primitives.CStringSequence)(unsafe.Pointer(&mem.name)), m.Name)
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.position)), m.Position)
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.velocity)), m.Velocity)
...
func (t _JointStateTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.StringSequenceToGo(&m.Name, *(*primitives.CStringSequence)(unsafe.Pointer(&mem.name)))
	primitives.Float64SequenceToGo(&m.Position, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.position)))
	primitives.Float64SequenceToGo(&m.Velocity, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.velocity)))
