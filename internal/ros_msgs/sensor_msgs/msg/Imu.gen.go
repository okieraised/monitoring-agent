...
// Imu
func NewImuPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ImuPublisher, error) {
...
// Imu
func NewImuSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ImuSubscriptionCallback) (*ImuSubscription, error) {
...
func (t _ImuTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float64ArrayToC(*(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_orientation_covariance)), m.OrientationCovariance[:])
	...
	primitives.Float64ArrayToC(*(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_angular_velocity_covariance)), m.AngularVelocityCovariance[:])
	...
	primitives.Float64ArrayToC(*(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_linear_acceleration_covariance)), m.LinearAccelerationCovariance[:])
}
...
func (t _ImuTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_orientation_covariance := mem.orientation_covariance[:]
	primitives.Float64ArrayToGo(m.OrientationCovariance[:], *(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_orientation_covariance)))
	geometry_msgs_msg.Vector3TypeSupport.AsGoStruct(&m.AngularVelocity, unsafe.Pointer(&mem.angular_velocity))
	cSlice_angular_velocity_covariance := mem.angular_velocity_covariance[:]
	primitives.Float64ArrayToGo(m.AngularVelocityCovariance[:], *(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_angular_velocity_covariance)))
	geometry_msgs_msg.Vector3TypeSupport.AsGoStruct(&m.LinearAcceleration, unsafe.Pointer(&mem.linear_acceleration))
	cSlice_linear_acceleration_covariance := mem.linear_acceleration_covariance[:]
	primitives.Float64ArrayToGo(m.LinearAccelerationCovariance[:], *(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_linear_acceleration_covariance)))
}
