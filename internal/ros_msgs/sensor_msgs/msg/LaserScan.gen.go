...
// LaserScan
func NewLaserScanPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LaserScanPublisher, error) {
...
// LaserScan
func NewLaserScanSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LaserScanSubscriptionCallback) (*LaserScanSubscription, error) {
...
func (t _LaserScanTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float32SequenceToC((*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.ranges)), m.Ranges)
	primitives.Float32SequenceToC((*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.intensities)), m.Intensities)
}
...
func (t _LaserScanTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float32SequenceToGo(&m.Ranges, *(*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.ranges)))
	primitives.Float32SequenceToGo(&m.Intensities, *(*primitives.CFloat32Sequence)(unsafe.Pointer(&mem.intensities)))
}
