...
// Image
func NewImagePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ImagePublisher, error) {
...
// Image
func NewImageSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ImageSubscriptionCallback) (*ImageSubscription, error) {
