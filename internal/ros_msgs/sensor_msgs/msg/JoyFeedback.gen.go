...
// JoyFeedback
func NewJoyFeedbackPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*JoyFeedbackPublisher, error) {
...
// JoyFeedback
func NewJoyFeedbackSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback JoyFeedbackSubscriptionCallback) (*JoyFeedbackSubscription, error) {
