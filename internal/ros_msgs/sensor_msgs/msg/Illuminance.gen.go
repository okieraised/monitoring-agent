...
// Illuminance
func NewIlluminancePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*IlluminancePublisher, error) {
...
// Illuminance
func NewIlluminanceSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback IlluminanceSubscriptionCallback) (*IlluminanceSubscription, error) {
