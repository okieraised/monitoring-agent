...
// NavSatStatus
func NewNavSatStatusPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*NavSatStatusPublisher, error) {
...
// NavSatStatus
func NewNavSatStatusSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback NavSatStatusSubscriptionCallback) (*NavSatStatusSubscription, error) {
