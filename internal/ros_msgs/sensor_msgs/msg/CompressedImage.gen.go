...
// CompressedImage
func NewCompressedImagePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*CompressedImagePublisher, error) {
...
// CompressedImage
func NewCompressedImageSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback CompressedImageSubscriptionCallback) (*CompressedImageSubscription, error) {
