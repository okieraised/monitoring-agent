...
// MultiEchoLaserScan
func NewMultiEchoLaserScanPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MultiEchoLaserScanPublisher, error) {
...
// MultiEchoLaserScan
func NewMultiEchoLaserScanSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MultiEchoLaserScanSubscriptionCallback) (*MultiEchoLaserScanSubscription, error) {
