...
// MultiDOFJointState
func NewMultiDOFJointStatePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MultiDOFJointStatePublisher, error) {
...
// MultiDOFJointState
func NewMultiDOFJointStateSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MultiDOFJointStateSubscriptionCallback) (*MultiDOFJointStateSubscription, error) {
