...
// Range
func NewRangePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*RangePublisher, error) {
...
// Range
func NewRangeSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback RangeSubscriptionCallback) (*RangeSubscription, error) {
