...
// MagneticField
func NewMagneticFieldPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MagneticFieldPublisher, error) {
...
// MagneticField
func NewMagneticFieldSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MagneticFieldSubscriptionCallback) (*MagneticFieldSubscription, error) {
...
func (t _MagneticFieldTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float64ArrayToC(*(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_magnetic_field_covariance)), m.MagneticFieldCovariance[:])
}
...
func (t _MagneticFieldTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_magnetic_field_covariance := mem.magnetic_field_covariance[:]
	primitives.Float64ArrayToGo(m.MagneticFieldCovariance[:], *(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_magnetic_field_covariance)))
}
