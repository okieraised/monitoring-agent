...
func NewSetCameraInfo_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetCameraInfo_ResponsePublisher, error) {
...
// SetCameraInfo_Response
func NewSetCameraInfo_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetCameraInfo_ResponseSubscriptionCallback) (*SetCameraInfo_ResponseSubscription, error) {
