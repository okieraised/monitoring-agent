...
// Vector3
func NewVector3Publisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Vector3Publisher, error) {
...
// Vector3
func NewVector3Subscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Vector3SubscriptionCallback) (*Vector3Subscription, error) {
