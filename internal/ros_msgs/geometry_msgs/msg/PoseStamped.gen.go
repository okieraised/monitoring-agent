...
// PoseStamped
func NewPoseStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PoseStampedPublisher, error) {
...
// PoseStamped
func NewPoseStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PoseStampedSubscriptionCallback) (*PoseStampedSubscription, error) {
