...
// Polygon
func NewPolygonPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PolygonPublisher, error) {
...
// Polygon
func NewPolygonSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PolygonSubscriptionCallback) (*PolygonSubscription, error) {
