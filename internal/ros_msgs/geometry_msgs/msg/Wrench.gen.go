...
// Wrench
func NewWrenchPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*WrenchPublisher, error) {
...
// Wrench
func NewWrenchSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback WrenchSubscriptionCallback) (*WrenchSubscription, error) {
