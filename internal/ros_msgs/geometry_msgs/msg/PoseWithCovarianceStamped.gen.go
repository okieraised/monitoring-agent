...
func NewPoseWithCovarianceStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PoseWithCovarianceStampedPublisher, error) {
...
// PoseWithCovarianceStamped
func NewPoseWithCovarianceStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PoseWithCovarianceStampedSubscriptionCallback) (*PoseWithCovarianceStampedSubscription, error) {
