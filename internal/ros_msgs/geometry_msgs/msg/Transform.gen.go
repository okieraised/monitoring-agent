...
// Transform
func NewTransformPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TransformPublisher, error) {
...
// Transform
func NewTransformSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TransformSubscriptionCallback) (*TransformSubscription, error) {
