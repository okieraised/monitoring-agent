...
func NewAccelWithCovarianceStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*AccelWithCovarianceStampedPublisher, error) {
...
// AccelWithCovarianceStamped
func NewAccelWithCovarianceStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback AccelWithCovarianceStampedSubscriptionCallback) (*AccelWithCovarianceStampedSubscription, error) {
