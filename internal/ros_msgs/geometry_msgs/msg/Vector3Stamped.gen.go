...
// Vector3Stamped
func NewVector3StampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Vector3StampedPublisher, error) {
...
// Vector3Stamped
func NewVector3StampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Vector3StampedSubscriptionCallback) (*Vector3StampedSubscription, error) {
