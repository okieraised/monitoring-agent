...
// TwistWithCovariance
func NewTwistWithCovariancePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TwistWithCovariancePublisher, error) {
...
// TwistWithCovariance
func NewTwistWithCovarianceSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TwistWithCovarianceSubscriptionCallback) (*TwistWithCovarianceSubscription, error) {
