...
// QuaternionStamped
func NewQuaternionStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*QuaternionStampedPublisher, error) {
...
// QuaternionStamped
func NewQuaternionStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback QuaternionStampedSubscriptionCallback) (*QuaternionStampedSubscription, error) {
