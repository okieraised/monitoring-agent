...
// Accel
func NewAccelPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*AccelPublisher, error) {
...
// Accel
func NewAccelSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback AccelSubscriptionCallback) (*AccelSubscription, error) {
