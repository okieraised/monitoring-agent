...
// Point
func NewPointPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PointPublisher, error) {
...
// Point
func NewPointSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PointSubscriptionCallback) (*PointSubscription, error) {
