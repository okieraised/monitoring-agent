...
// TwistStamped
func NewTwistStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TwistStampedPublisher, error) {
...
// TwistStamped
func NewTwistStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TwistStampedSubscriptionCallback) (*TwistStampedSubscription, error) {
