...
// Twist
func NewTwistPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TwistPublisher, error) {
...
// Twist
func NewTwistSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TwistSubscriptionCallback) (*TwistSubscription, error) {
