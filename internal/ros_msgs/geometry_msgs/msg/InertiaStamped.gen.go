...
// InertiaStamped
func NewInertiaStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*InertiaStampedPublisher, error) {
...
// InertiaStamped
func NewInertiaStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback InertiaStampedSubscriptionCallback) (*InertiaStampedSubscription, error) {
