...
// TransformStamped
func NewTransformStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TransformStampedPublisher, error) {
...
// TransformStamped
func NewTransformStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TransformStampedSubscriptionCallback) (*TransformStampedSubscription, error) {
