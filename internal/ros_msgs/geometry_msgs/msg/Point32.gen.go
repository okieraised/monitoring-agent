...
// Point32
func NewPoint32Publisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Point32Publisher, error) {
...
// Point32
func NewPoint32Subscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Point32SubscriptionCallback) (*Point32Subscription, error) {
