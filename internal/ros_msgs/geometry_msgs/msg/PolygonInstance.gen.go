...
// PolygonInstance
func NewPolygonInstancePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PolygonInstancePublisher, error) {
...
// PolygonInstance
func NewPolygonInstanceSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PolygonInstanceSubscriptionCallback) (*PolygonInstanceSubscription, error) {
