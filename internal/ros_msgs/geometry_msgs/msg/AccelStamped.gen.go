...
// AccelStamped
func NewAccelStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*AccelStampedPublisher, error) {
...
// AccelStamped
func NewAccelStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback AccelStampedSubscriptionCallback) (*AccelStampedSubscription, error) {
