...
// AccelWithCovariance
func NewAccelWithCovariancePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*AccelWithCovariancePublisher, error) {
...
// AccelWithCovariance
func NewAccelWithCovarianceSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback AccelWithCovarianceSubscriptionCallback) (*AccelWithCovarianceSubscription, error) {
