...
// Quaternion
func NewQuaternionPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*QuaternionPublisher, error) {
...
// Quaternion
func NewQuaternionSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback QuaternionSubscriptionCallback) (*QuaternionSubscription, error) {
