...
// PoseArray
func NewPoseArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PoseArrayPublisher, error) {
...
// PoseArray
func NewPoseArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PoseArraySubscriptionCallback) (*PoseArraySubscription, error) {
