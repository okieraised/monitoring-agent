...
// WrenchStamped
func NewWrenchStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*WrenchStampedPublisher, error) {
...
// WrenchStamped
func NewWrenchStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback WrenchStampedSubscriptionCallback) (*WrenchStampedSubscription, error) {
