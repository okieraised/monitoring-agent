...
// VelocityStamped
func NewVelocityStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*VelocityStampedPublisher, error) {
...
// VelocityStamped
func NewVelocityStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback VelocityStampedSubscriptionCallback) (*VelocityStampedSubscription, error) {
