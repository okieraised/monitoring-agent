...
func NewTwistWithCovarianceStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TwistWithCovarianceStampedPublisher, error) {
...
// TwistWithCovarianceStamped
func NewTwistWithCovarianceStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TwistWithCovarianceStampedSubscriptionCallback) (*TwistWithCovarianceStampedSubscription, error) {
