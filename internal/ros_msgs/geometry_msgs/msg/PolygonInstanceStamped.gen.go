...
func NewPolygonInstanceStampedPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PolygonInstanceStampedPublisher, error) {
...
// PolygonInstanceStamped
func NewPolygonInstanceStampedSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PolygonInstanceStampedSubscriptionCallback) (*PolygonInstanceStampedSubscription, error) {
