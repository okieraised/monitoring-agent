...
// MeshTriangle
func NewMeshTrianglePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MeshTrianglePublisher, error) {
...
// MeshTriangle
func NewMeshTriangleSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MeshTriangleSubscriptionCallback) (*MeshTriangleSubscription, error) {
...
func (t _MeshTriangleTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Uint32ArrayToC(*(*[]primitives.CUint32)(unsafe.Pointer(&cSlice_vertex_indices)), m.VertexIndices[:])
}
...
func (t _MeshTriangleTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_vertex_indices := mem.vertex_indices[:]
	primitives.Uint32ArrayToGo(m.VertexIndices[:], *(*[]primitives.CUint32)(unsafe.Pointer(&cSlice_vertex_indices)))
}
