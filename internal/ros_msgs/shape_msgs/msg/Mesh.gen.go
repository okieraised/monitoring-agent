...
// Mesh
func NewMeshPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MeshPublisher, error) {
...
// Mesh
func NewMeshSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MeshSubscriptionCallback) (*MeshSubscription, error) {
