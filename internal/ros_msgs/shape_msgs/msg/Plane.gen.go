...
// Plane
func NewPlanePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*PlanePublisher, error) {
...
// Plane
func NewPlaneSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback PlaneSubscriptionCallback) (*PlaneSubscription, error) {
...
func (t _PlaneTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float64ArrayToC(*(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_coef)), m.Coef[:])
}
...
func (t _PlaneTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_coef := mem.coef[:]
	primitives.Float64ArrayToGo(m.Coef[:], *(*[]primitives.CFloat64)(unsafe.Pointer(&cSlice_coef)))
}
