...
// SolidPrimitive
func NewSolidPrimitivePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SolidPrimitivePublisher, error) {
...
// SolidPrimitive
func NewSolidPrimitiveSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SolidPrimitiveSubscriptionCallback) (*SolidPrimitiveSubscription, error) {
...
func (t _SolidPrimitiveTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.dimensions)), m.Dimensions)
...
func (t _SolidPrimitiveTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float64SequenceToGo(&m.Dimensions, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.dimensions)))
