...
// Goals
func NewGoalsPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GoalsPublisher, error) {
...
// Goals
func NewGoalsSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GoalsSubscriptionCallback) (*GoalsSubscription, error) {
