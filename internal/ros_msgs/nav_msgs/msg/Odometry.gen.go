...
// Odometry
func NewOdometryPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*OdometryPublisher, error) {
...
// Odometry
func NewOdometrySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback OdometrySubscriptionCallback) (*OdometrySubscription, error) {
