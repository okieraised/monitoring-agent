...
// GridCells
func NewGridCellsPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GridCellsPublisher, error) {
...
// GridCells
func NewGridCellsSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GridCellsSubscriptionCallback) (*GridCellsSubscription, error) {
