...
// SetMap_Request
func NewSetMap_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetMap_RequestPublisher, error) {
...
// SetMap_Request
func NewSetMap_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetMap_RequestSubscriptionCallback) (*SetMap_RequestSubscription, error) {
