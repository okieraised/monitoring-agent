...
// GetMap_Response
func NewGetMap_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetMap_ResponsePublisher, error) {
...
// GetMap_Response
func NewGetMap_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetMap_ResponseSubscriptionCallback) (*GetMap_ResponseSubscription, error) {
