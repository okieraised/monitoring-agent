...
// LoadNode_Response
func NewLoadNode_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LoadNode_ResponsePublisher, error) {
...
// LoadNode_Response
func NewLoadNode_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LoadNode_ResponseSubscriptionCallback) (*LoadNode_ResponseSubscription, error) {
