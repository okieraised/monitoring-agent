...
// LoadNode_Request
func NewLoadNode_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LoadNode_RequestPublisher, error) {
	pub, err := node.NewPublisher(topicName, LoadNode_RequestTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// LoadNode_Request
func NewLoadNode_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LoadNode_RequestSubscriptionCallback) (*LoadNode_RequestSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg LoadNode_Request
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, LoadNode_RequestTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (t _LoadNode_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.StringSequenceToC((*primitives.CStringSequence)(unsafe.Pointer(&mem.remap_rules)), m.RemapRules)
	rcl_interfaces_msg.ParameterSequenceToC((*rcl_interfaces_msg.CParameterSequence)(unsafe.Pointer(&mem.parameters)), m.Parameters)
	rcl_interfaces_msg.ParameterSequenceToC((*rcl_interfaces_msg.CParameterSequence)(unsafe.Pointer(&mem.extra_arguments)), m.ExtraArguments)
}
...
func (t _LoadNode_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.StringSequenceToGo(&m.RemapRules, *(*primitives.CStringSequence)(unsafe.Pointer(&mem.remap_rules)))
	...
	rcl_interfaces_msg.ParameterSequenceToGo(&m.ExtraArguments, *(*rcl_interfaces_msg.CParameterSequence)(unsafe.Pointer(&mem.extra_arguments)))
}
...
type CLoadNode_RequestSequence = C.composition_interfaces__srv__LoadNode_Request__Sequence

func LoadNode_RequestSequenceToGo(goSlice *[]LoadNode_Request, cSlice CLoadNode_RequestSequence) {
	if cSlice.size == 0 {
		return
	}
...
func LoadNode_RequestSequenceToC(cSlice *CLoadNode_RequestSequence, goSlice []LoadNode_Request) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func LoadNode_RequestArrayToGo(goSlice []LoadNode_Request, cSlice []CLoadNode_Request) {
	for i := 0; i < len(cSlice); i++ {
		LoadNode_RequestTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func LoadNode_RequestArrayToC(cSlice []CLoadNode_Request, goSlice []LoadNode_Request) {
