...
// ListNodes_Response
func NewListNodes_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ListNodes_ResponsePublisher, error) {
...
// ListNodes_Response
func NewListNodes_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ListNodes_ResponseSubscriptionCallback) (*ListNodes_ResponseSubscription, error) {
...
func (t _ListNodes_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.StringSequenceToC((*primitives.CStringSequence)(unsafe.Pointer(&mem.full_node_names)), m.FullNodeNames)
	primitives.Uint64SequenceToC((*primitives.CUint64Sequence)(unsafe.Pointer(&mem.unique_ids)), m.UniqueIds)
}
...
func (t _ListNodes_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.StringSequenceToGo(&m.FullNodeNames, *(*primitives.CStringSequence)(unsafe.Pointer(&mem.full_node_names)))
	primitives.Uint64SequenceToGo(&m.UniqueIds, *(*primitives.CUint64Sequence)(unsafe.Pointer(&mem.unique_ids)))
}
