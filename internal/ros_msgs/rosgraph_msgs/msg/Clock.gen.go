...
// Clock
func NewClockPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ClockPublisher, error) {
...
// Clock
func NewClockSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ClockSubscriptionCallback) (*ClockSubscription, error) {
