...
func NewGetAvailableTransitions_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetAvailableTransitions_ResponsePublisher, error) {
...
// GetAvailableTransitions_Response
func NewGetAvailableTransitions_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetAvailableTransitions_ResponseSubscriptionCallback) (*GetAvailableTransitions_ResponseSubscription, error) {
