...
// ChangeState_Request
func NewChangeState_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ChangeState_RequestPublisher, error) {
...
// ChangeState_Request
func NewChangeState_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ChangeState_RequestSubscriptionCallback) (*ChangeState_RequestSubscription, error) {
