...
// GetState_Response
func NewGetState_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetState_ResponsePublisher, error) {
...
// GetState_Response
func NewGetState_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetState_ResponseSubscriptionCallback) (*GetState_ResponseSubscription, error) {
