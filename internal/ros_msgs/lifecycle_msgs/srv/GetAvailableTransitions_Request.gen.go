...
func NewGetAvailableTransitions_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetAvailableTransitions_RequestPublisher, error) {
...
// GetAvailableTransitions_Request
func NewGetAvailableTransitions_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetAvailableTransitions_RequestSubscriptionCallback) (*GetAvailableTransitions_RequestSubscription, error) {
