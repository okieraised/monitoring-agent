...
// GetState_Request
func NewGetState_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetState_RequestPublisher, error) {
...
// GetState_Request
func NewGetState_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetState_RequestSubscriptionCallback) (*GetState_RequestSubscription, error) {
