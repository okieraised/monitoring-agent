...
func NewTransitionDescriptionPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TransitionDescriptionPublisher, error) {
...
// TransitionDescription
func NewTransitionDescriptionSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TransitionDescriptionSubscriptionCallback) (*TransitionDescriptionSubscription, error) {
