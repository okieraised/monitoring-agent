...
// UUID
func NewUUIDPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*UUIDPublisher, error) {
...
// UUID
func NewUUIDSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback UUIDSubscriptionCallback) (*UUIDSubscription, error) {
...
func (t _UUIDTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Uint8ArrayToC(*(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_uuid)), m.Uuid[:])
}
...
func (t _UUIDTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	cSlice_uuid := mem.uuid[:]
	primitives.Uint8ArrayToGo(m.Uuid[:], *(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_uuid)))
}
