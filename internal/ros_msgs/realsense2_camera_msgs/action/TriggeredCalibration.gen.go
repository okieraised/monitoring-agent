...
func init() {
	<no value>.RegisterAction("realsense2_camera_msgs/TriggeredCalibration", TriggeredCalibrationTypeSupport)
	<no value>.RegisterAction("realsense2_camera_msgs/action/TriggeredCalibration", TriggeredCalibrationTypeSupport)
}

type _TriggeredCalibrationTypeSupport struct {}

func (s _TriggeredCalibrationTypeSupport) Goal() <no value>.MessageTypeSupport {
	return TriggeredCalibration_GoalTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) SendGoal() <no value>.ServiceTypeSupport {
	return TriggeredCalibration_SendGoalTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) NewSendGoalResponse(accepted bool, stamp time.Duration) <no value>.Message {
...
func (s _TriggeredCalibrationTypeSupport) Result() <no value>.MessageTypeSupport {
	return TriggeredCalibration_ResultTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) GetResult() <no value>.ServiceTypeSupport {
	return TriggeredCalibration_GetResultTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) NewGetResultResponse(status int8, result types.Message) <no value>.Message {
...
func (s _TriggeredCalibrationTypeSupport) CancelGoal() <no value>.ServiceTypeSupport {
	return action_msgs_srv.CancelGoalTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) Feedback() <no value>.MessageTypeSupport {
	return TriggeredCalibration_FeedbackTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) FeedbackMessage() <no value>.MessageTypeSupport {
	return TriggeredCalibration_FeedbackMessageTypeSupport
}

func (s _TriggeredCalibrationTypeSupport) NewFeedbackMessage(goalID *<no value>.GoalID, feedback <no value>.Message) <no value>.Message {
...
func (s _TriggeredCalibrationTypeSupport) GoalStatusArray() <no value>.MessageTypeSupport {
...
var TriggeredCalibrationTypeSupport <no value>.ActionTypeSupport = _TriggeredCalibrationTypeSupport{}
...
func (a _TriggeredCalibrationAction) ExecuteGoal(ctx context.Context, handle *<no value>.GoalHandle) (<no value>.Message, error) {
...
func (a _TriggeredCalibrationAction) TypeSupport() <no value>.ActionTypeSupport {
...
func NewTriggeredCalibrationServer(node *<no value>.Node, name string, action TriggeredCalibrationAction, opts *<no value>.ActionServerOptions) (*TriggeredCalibrationServer, error) {
...
func NewTriggeredCalibrationClient(node *<no value>.Node, name string, opts *<no value>.ActionClientOptions) (*TriggeredCalibrationClient, error) {
...
func (c *TriggeredCalibrationClient) WatchGoal(ctx context.Context, goal *TriggeredCalibration_Goal, onFeedback TriggeredCalibrationFeedbackHandler) (*TriggeredCalibration_GetResult_Response, *<no value>.GoalID, error) {
...
func (c *TriggeredCalibrationClient) SendGoal(ctx context.Context, goal *TriggeredCalibration_Goal) (*TriggeredCalibration_SendGoal_Response, *<no value>.GoalID, error) {
...
func (c *TriggeredCalibrationClient) GetResult(ctx context.Context, goalID *<no value>.GoalID) (*TriggeredCalibration_GetResult_Response, error) {
...
func (c *TriggeredCalibrationClient) WatchFeedback(ctx context.Context, goalID *<no value>.GoalID, handler TriggeredCalibrationFeedbackHandler) <-chan error {
...
func (c *TriggeredCalibrationClient) WatchStatus(ctx context.Context, goalID *<no value>.GoalID, handler TriggeredCalibrationStatusHandler) <-chan error {
