...
// DiagnosticStatus
func NewDiagnosticStatusPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*DiagnosticStatusPublisher, error) {
...
// DiagnosticStatus
func NewDiagnosticStatusSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback DiagnosticStatusSubscriptionCallback) (*DiagnosticStatusSubscription, error) {
