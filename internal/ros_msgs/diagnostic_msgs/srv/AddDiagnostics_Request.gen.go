...
func NewAddDiagnostics_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*AddDiagnostics_RequestPublisher, error) {
...
// AddDiagnostics_Request
func NewAddDiagnostics_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback AddDiagnostics_RequestSubscriptionCallback) (*AddDiagnostics_RequestSubscription, error) {
