...
// SelfTest_Response
func NewSelfTest_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SelfTest_ResponsePublisher, error) {
...
// SelfTest_Response
func NewSelfTest_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SelfTest_ResponseSubscriptionCallback) (*SelfTest_ResponseSubscription, error) {
