...
func NewAddDiagnostics_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*AddDiagnostics_ResponsePublisher, error) {
...
// AddDiagnostics_Response
func NewAddDiagnostics_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback AddDiagnostics_ResponseSubscriptionCallback) (*AddDiagnostics_ResponseSubscription, error) {
