...
func init() {
	...
	typemap.RegisterMessage("statistics_msgs/msg/StatisticDataPoint", StatisticDataPointTypeSupport)
}
...
func (t *StatisticDataPoint) GetTypeSupport() types.MessageTypeSupport {
	return StatisticDataPointTypeSupport
}

// StatisticDataPointPublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
// StatisticDataPoint
func NewStatisticDataPointPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*StatisticDataPointPublisher, error) {
...
// StatisticDataPointSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type StatisticDataPointSubscriptionCallback func(msg *StatisticDataPoint, info *rclgo.MessageInfo, err error)

// NewStatisticDataPointSubscription creates and returns a new subscription for the
// StatisticDataPoint
func NewStatisticDataPointSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback StatisticDataPointSubscriptionCallback) (*StatisticDataPointSubscription, error) {
...
func (s *StatisticDataPointSubscription) TakeMessage(out *StatisticDataPoint) (*rclgo.MessageInfo, error) {
