...
// MetricsMessage
func NewMetricsMessagePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MetricsMessagePublisher, error) {
...
// MetricsMessage
func NewMetricsMessageSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MetricsMessageSubscriptionCallback) (*MetricsMessageSubscription, error) {
