...
// StatisticDataType
func NewStatisticDataTypePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*StatisticDataTypePublisher, error) {
...
// StatisticDataType
func NewStatisticDataTypeSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback StatisticDataTypeSubscriptionCallback) (*StatisticDataTypeSubscription, error) {
