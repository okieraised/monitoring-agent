...
func NewMultiDOFJointTrajectoryPointPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MultiDOFJointTrajectoryPointPublisher, error) {
...
// MultiDOFJointTrajectoryPoint
func NewMultiDOFJointTrajectoryPointSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MultiDOFJointTrajectoryPointSubscriptionCallback) (*MultiDOFJointTrajectoryPointSubscription, error) {
