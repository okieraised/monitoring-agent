...
func NewMultiDOFJointTrajectoryPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MultiDOFJointTrajectoryPublisher, error) {
...
// MultiDOFJointTrajectory
func NewMultiDOFJointTrajectorySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MultiDOFJointTrajectorySubscriptionCallback) (*MultiDOFJointTrajectorySubscription, error) {
...
func (t _MultiDOFJointTrajectoryTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.StringSequenceToC((*primitives.CStringSequence)(unsafe.Pointer(&mem.joint_names)), m.JointNames)
...
func (t _MultiDOFJointTrajectoryTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.StringSequenceToGo(&m.JointNames, *(*primitives.CStringSequence)(unsafe.Pointer(&mem.joint_names)))
