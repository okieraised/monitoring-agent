...
func NewJointTrajectoryPointPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*JointTrajectoryPointPublisher, error) {
...
// JointTrajectoryPoint
func NewJointTrajectoryPointSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback JointTrajectoryPointSubscriptionCallback) (*JointTrajectoryPointSubscription, error) {
...
func (t _JointTrajectoryPointTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.positions)), m.Positions)
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.velocities)), m.Velocities)
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.accelerations)), m.Accelerations)
	primitives.Float64SequenceToC((*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.effort)), m.Effort)
...
func (t _JointTrajectoryPointTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Float64SequenceToGo(&m.Positions, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.positions)))
	primitives.Float64SequenceToGo(&m.Velocities, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.velocities)))
	primitives.Float64SequenceToGo(&m.Accelerations, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.accelerations)))
	primitives.Float64SequenceToGo(&m.Effort, *(*primitives.CFloat64Sequence)(unsafe.Pointer(&mem.effort)))
