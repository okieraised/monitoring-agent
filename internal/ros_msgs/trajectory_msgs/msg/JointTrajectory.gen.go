...
// JointTrajectory
func NewJointTrajectoryPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*JointTrajectoryPublisher, error) {
...
// JointTrajectory
func NewJointTrajectorySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback JointTrajectorySubscriptionCallback) (*JointTrajectorySubscription, error) {
