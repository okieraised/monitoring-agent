...
func init() {
	<no value>.RegisterService("as2_msgs/SetOffboardMode_SendGoal", SetOffboardMode_SendGoalTypeSupport)
	<no value>.RegisterService("as2_msgs/action/SetOffboardMode_SendGoal", SetOffboardMode_SendGoalTypeSupport)
}

type _SetOffboardMode_SendGoalTypeSupport struct {}

func (s _SetOffboardMode_SendGoalTypeSupport) Request() <no value>.MessageTypeSupport {
	return SetOffboardMode_SendGoal_RequestTypeSupport
}

func (s _SetOffboardMode_SendGoalTypeSupport) Response() <no value>.MessageTypeSupport {
...
var SetOffboardMode_SendGoalTypeSupport <no value>.ServiceTypeSupport = _SetOffboardMode_SendGoalTypeSupport{}

// SetOffboardMode_SendGoalClient wraps <no value>.Client to provide type safe helper
// functions
...
func NewSetOffboardMode_SendGoalClient(node *<no value>.Node, serviceName string, options *<no value>.ClientOptions) (*SetOffboardMode_SendGoalClient, error) {
...
func (s *SetOffboardMode_SendGoalClient) Send(ctx context.Context, req *SetOffboardMode_SendGoal_Request) (*SetOffboardMode_SendGoal_Response, *<no value>.ServiceInfo, error) {
...
type SetOffboardMode_SendGoalServiceRequestHandler func(*<no value>.ServiceInfo, *SetOffboardMode_SendGoal_Request, SetOffboardMode_SendGoalServiceResponseSender)

// SetOffboardMode_SendGoalService wraps <no value>.Service to provide type safe helper
// functions
...
// SetOffboardMode_SendGoal
func NewSetOffboardMode_SendGoalService(node *<no value>.Node, name string, options *<no value>.ServiceOptions, handler SetOffboardMode_SendGoalServiceRequestHandler) (*SetOffboardMode_SendGoalService, error) {
