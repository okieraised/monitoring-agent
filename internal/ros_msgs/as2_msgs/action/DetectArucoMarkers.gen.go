...
func init() {
	<no value>.RegisterAction("as2_msgs/DetectArucoMarkers", DetectArucoMarkersTypeSupport)
	<no value>.RegisterAction("as2_msgs/action/DetectArucoMarkers", DetectArucoMarkersTypeSupport)
}

type _DetectArucoMarkersTypeSupport struct {}

func (s _DetectArucoMarkersTypeSupport) Goal() <no value>.MessageTypeSupport {
	return DetectArucoMarkers_GoalTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) SendGoal() <no value>.ServiceTypeSupport {
	return DetectArucoMarkers_SendGoalTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) NewSendGoalResponse(accepted bool, stamp time.Duration) <no value>.Message {
...
func (s _DetectArucoMarkersTypeSupport) Result() <no value>.MessageTypeSupport {
	return DetectArucoMarkers_ResultTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) GetResult() <no value>.ServiceTypeSupport {
	return DetectArucoMarkers_GetResultTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) NewGetResultResponse(status int8, result types.Message) <no value>.Message {
...
func (s _DetectArucoMarkersTypeSupport) CancelGoal() <no value>.ServiceTypeSupport {
	return action_msgs_srv.CancelGoalTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) Feedback() <no value>.MessageTypeSupport {
	return DetectArucoMarkers_FeedbackTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) FeedbackMessage() <no value>.MessageTypeSupport {
	return DetectArucoMarkers_FeedbackMessageTypeSupport
}

func (s _DetectArucoMarkersTypeSupport) NewFeedbackMessage(goalID *<no value>.GoalID, feedback <no value>.Message) <no value>.Message {
...
func (s _DetectArucoMarkersTypeSupport) GoalStatusArray() <no value>.MessageTypeSupport {
...
var DetectArucoMarkersTypeSupport <no value>.ActionTypeSupport = _DetectArucoMarkersTypeSupport{}
...
func (a _DetectArucoMarkersAction) ExecuteGoal(ctx context.Context, handle *<no value>.GoalHandle) (<no value>.Message, error) {
...
func (a _DetectArucoMarkersAction) TypeSupport() <no value>.ActionTypeSupport {
...
func NewDetectArucoMarkersServer(node *<no value>.Node, name string, action DetectArucoMarkersAction, opts *<no value>.ActionServerOptions) (*DetectArucoMarkersServer, error) {
...
func NewDetectArucoMarkersClient(node *<no value>.Node, name string, opts *<no value>.ActionClientOptions) (*DetectArucoMarkersClient, error) {
...
func (c *DetectArucoMarkersClient) WatchGoal(ctx context.Context, goal *DetectArucoMarkers_Goal, onFeedback DetectArucoMarkersFeedbackHandler) (*DetectArucoMarkers_GetResult_Response, *<no value>.GoalID, error) {
...
func (c *DetectArucoMarkersClient) SendGoal(ctx context.Context, goal *DetectArucoMarkers_Goal) (*DetectArucoMarkers_SendGoal_Response, *<no value>.GoalID, error) {
...
func (c *DetectArucoMarkersClient) GetResult(ctx context.Context, goalID *<no value>.GoalID) (*DetectArucoMarkers_GetResult_Response, error) {
...
func (c *DetectArucoMarkersClient) WatchFeedback(ctx context.Context, goalID *<no value>.GoalID, handler DetectArucoMarkersFeedbackHandler) <-chan error {
...
func (c *DetectArucoMarkersClient) WatchStatus(ctx context.Context, goalID *<no value>.GoalID, handler DetectArucoMarkersStatusHandler) <-chan error {
