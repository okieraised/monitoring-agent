...
func NewSetParameters_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetParameters_RequestPublisher, error) {
...
// SetParameters_Request
func NewSetParameters_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetParameters_RequestSubscriptionCallback) (*SetParameters_RequestSubscription, error) {
