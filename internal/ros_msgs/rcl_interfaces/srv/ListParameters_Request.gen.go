...
func NewListParameters_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ListParameters_RequestPublisher, error) {
...
// ListParameters_Request
func NewListParameters_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ListParameters_RequestSubscriptionCallback) (*ListParameters_RequestSubscription, error) {
