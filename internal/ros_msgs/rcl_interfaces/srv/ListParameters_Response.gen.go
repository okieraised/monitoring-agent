...
func NewListParameters_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ListParameters_ResponsePublisher, error) {
...
// ListParameters_Response
func NewListParameters_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ListParameters_ResponseSubscriptionCallback) (*ListParameters_ResponseSubscription, error) {
