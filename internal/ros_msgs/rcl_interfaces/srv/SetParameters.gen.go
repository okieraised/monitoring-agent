...
func init() {
	<no value>.RegisterService("rcl_interfaces/SetParameters", SetParametersTypeSupport)
	<no value>.RegisterService("rcl_interfaces/srv/SetParameters", SetParametersTypeSupport)
}

type _SetParametersTypeSupport struct {}

func (s _SetParametersTypeSupport) Request() <no value>.MessageTypeSupport {
	return SetParameters_RequestTypeSupport
}

func (s _SetParametersTypeSupport) Response() <no value>.MessageTypeSupport {
...
var SetParametersTypeSupport <no value>.ServiceTypeSupport = _SetParametersTypeSupport{}

// SetParametersClient wraps <no value>.Client to provide type safe helper
// functions
...
// SetParameters
func NewSetParametersClient(node *<no value>.Node, serviceName string, options *<no value>.ClientOptions) (*SetParametersClient, error) {
...
func (s *SetParametersClient) Send(ctx context.Context, req *SetParameters_Request) (*SetParameters_Response, *<no value>.ServiceInfo, error) {
...
type SetParametersServiceRequestHandler func(*<no value>.ServiceInfo, *SetParameters_Request, SetParametersServiceResponseSender)

// SetParametersService wraps <no value>.Service to provide type safe helper
// functions
...
// SetParameters
func NewSetParametersService(node *<no value>.Node, name string, options *<no value>.ServiceOptions, handler SetParametersServiceRequestHandler) (*SetParametersService, error) {
