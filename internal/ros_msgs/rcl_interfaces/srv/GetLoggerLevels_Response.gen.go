...
type GetLoggerLevels_Response struct {
	Levels []rcl_interfaces_msg.LoggerLevel `yaml:"levels"` // List of logger levels which is the same order as the provided names. If alogger was not yet set, the value will have 'unknown' as the value.
}
...
func NewGetLoggerLevels_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetLoggerLevels_ResponsePublisher, error) {
	pub, err := node.NewPublisher(topicName, GetLoggerLevels_ResponseTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// GetLoggerLevels_Response
func NewGetLoggerLevels_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetLoggerLevels_ResponseSubscriptionCallback) (*GetLoggerLevels_ResponseSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg GetLoggerLevels_Response
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, GetLoggerLevels_ResponseTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (t _GetLoggerLevels_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rcl_interfaces_msg.LoggerLevelSequenceToC((*rcl_interfaces_msg.CLoggerLevelSequence)(unsafe.Pointer(&mem.levels)), m.Levels)
}
...
func (t _GetLoggerLevels_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	rcl_interfaces_msg.LoggerLevelSequenceToGo(&m.Levels, *(*rcl_interfaces_msg.CLoggerLevelSequence)(unsafe.Pointer(&mem.levels)))
}
...
type CGetLoggerLevels_ResponseSequence = C.rcl_interfaces__srv__GetLoggerLevels_Response__Sequence

func GetLoggerLevels_ResponseSequenceToGo(goSlice *[]GetLoggerLevels_Response, cSlice CGetLoggerLevels_ResponseSequence) {
	if cSlice.size == 0 {
		return
	}
...
func GetLoggerLevels_ResponseSequenceToC(cSlice *CGetLoggerLevels_ResponseSequence, goSlice []GetLoggerLevels_Response) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func GetLoggerLevels_ResponseArrayToGo(goSlice []GetLoggerLevels_Response, cSlice []CGetLoggerLevels_Response) {
	for i := 0; i < len(cSlice); i++ {
		GetLoggerLevels_ResponseTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func GetLoggerLevels_ResponseArrayToC(cSlice []CGetLoggerLevels_Response, goSlice []GetLoggerLevels_Response) {
