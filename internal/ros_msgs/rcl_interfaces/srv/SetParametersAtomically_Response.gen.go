...
func NewSetParametersAtomically_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetParametersAtomically_ResponsePublisher, error) {
...
// SetParametersAtomically_Response
func NewSetParametersAtomically_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetParametersAtomically_ResponseSubscriptionCallback) (*SetParametersAtomically_ResponseSubscription, error) {
