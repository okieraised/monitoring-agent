...
func NewGetParameterTypes_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetParameterTypes_ResponsePublisher, error) {
...
// GetParameterTypes_Response
func NewGetParameterTypes_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetParameterTypes_ResponseSubscriptionCallback) (*GetParameterTypes_ResponseSubscription, error) {
...
func (t _GetParameterTypes_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Uint8SequenceToC((*primitives.CUint8Sequence)(unsafe.Pointer(&mem.types)), m.Types)
}
...
func (t _GetParameterTypes_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.Uint8SequenceToGo(&m.Types, *(*primitives.CUint8Sequence)(unsafe.Pointer(&mem.types)))
}
