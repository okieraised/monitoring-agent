...
func NewDescribeParameters_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*DescribeParameters_RequestPublisher, error) {
...
// DescribeParameters_Request
func NewDescribeParameters_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback DescribeParameters_RequestSubscriptionCallback) (*DescribeParameters_RequestSubscription, error) {
