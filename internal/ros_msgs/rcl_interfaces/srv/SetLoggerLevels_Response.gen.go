...
type SetLoggerLevels_Response struct {
	Results []rcl_interfaces_msg.SetLoggerLevelsResult `yaml:"results"` // Indicates whether setting each logger succeeded or not and why.
}
...
func NewSetLoggerLevels_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetLoggerLevels_ResponsePublisher, error) {
	pub, err := node.NewPublisher(topicName, SetLoggerLevels_ResponseTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// SetLoggerLevels_Response
func NewSetLoggerLevels_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetLoggerLevels_ResponseSubscriptionCallback) (*SetLoggerLevels_ResponseSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg SetLoggerLevels_Response
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, SetLoggerLevels_ResponseTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (t _SetLoggerLevels_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	rcl_interfaces_msg.SetLoggerLevelsResultSequenceToC((*rcl_interfaces_msg.CSetLoggerLevelsResultSequence)(unsafe.Pointer(&mem.results)), m.Results)
}
...
func (t _SetLoggerLevels_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	rcl_interfaces_msg.SetLoggerLevelsResultSequenceToGo(&m.Results, *(*rcl_interfaces_msg.CSetLoggerLevelsResultSequence)(unsafe.Pointer(&mem.results)))
}
...
type CSetLoggerLevels_ResponseSequence = C.rcl_interfaces__srv__SetLoggerLevels_Response__Sequence

func SetLoggerLevels_ResponseSequenceToGo(goSlice *[]SetLoggerLevels_Response, cSlice CSetLoggerLevels_ResponseSequence) {
	if cSlice.size == 0 {
		return
	}
...
func SetLoggerLevels_ResponseSequenceToC(cSlice *CSetLoggerLevels_ResponseSequence, goSlice []SetLoggerLevels_Response) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func SetLoggerLevels_ResponseArrayToGo(goSlice []SetLoggerLevels_Response, cSlice []CSetLoggerLevels_Response) {
	for i := 0; i < len(cSlice); i++ {
		SetLoggerLevels_ResponseTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func SetLoggerLevels_ResponseArrayToC(cSlice []CSetLoggerLevels_Response, goSlice []SetLoggerLevels_Response) {
