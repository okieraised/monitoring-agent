...
// SetParametersResult
func NewSetParametersResultPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*SetParametersResultPublisher, error) {
...
// SetParametersResult
func NewSetParametersResultSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback SetParametersResultSubscriptionCallback) (*SetParametersResultSubscription, error) {
