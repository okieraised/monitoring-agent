...
// ParameterType
func NewParameterTypePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ParameterTypePublisher, error) {
...
// ParameterType
func NewParameterTypeSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ParameterTypeSubscriptionCallback) (*ParameterTypeSubscription, error) {
