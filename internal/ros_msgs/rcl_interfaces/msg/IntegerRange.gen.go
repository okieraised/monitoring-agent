...
// IntegerRange
func NewIntegerRangePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*IntegerRangePublisher, error) {
...
// IntegerRange
func NewIntegerRangeSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback IntegerRangeSubscriptionCallback) (*IntegerRangeSubscription, error) {
