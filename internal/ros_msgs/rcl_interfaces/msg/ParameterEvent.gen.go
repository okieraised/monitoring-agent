...
// ParameterEvent
func NewParameterEventPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ParameterEventPublisher, error) {
...
// ParameterEvent
func NewParameterEventSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ParameterEventSubscriptionCallback) (*ParameterEventSubscription, error) {
