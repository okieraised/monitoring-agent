...
func NewParameterEventDescriptorsPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ParameterEventDescriptorsPublisher, error) {
...
// ParameterEventDescriptors
func NewParameterEventDescriptorsSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ParameterEventDescriptorsSubscriptionCallback) (*ParameterEventDescriptorsSubscription, error) {
