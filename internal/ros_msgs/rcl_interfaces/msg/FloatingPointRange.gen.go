...
// FloatingPointRange
func NewFloatingPointRangePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*FloatingPointRangePublisher, error) {
...
// FloatingPointRange
func NewFloatingPointRangeSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback FloatingPointRangeSubscriptionCallback) (*FloatingPointRangeSubscription, error) {
