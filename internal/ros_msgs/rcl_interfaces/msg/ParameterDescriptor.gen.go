...
// ParameterDescriptor
func NewParameterDescriptorPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ParameterDescriptorPublisher, error) {
...
// ParameterDescriptor
func NewParameterDescriptorSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ParameterDescriptorSubscriptionCallback) (*ParameterDescriptorSubscription, error) {
