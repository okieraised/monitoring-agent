...
func NewListParametersResultPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*ListParametersResultPublisher, error) {
...
// ListParametersResult
func NewListParametersResultSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback ListParametersResultSubscriptionCallback) (*ListParametersResultSubscription, error) {
...
func (t _ListParametersResultTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.StringSequenceToC((*primitives.CStringSequence)(unsafe.Pointer(&mem.prefixes)), m.Prefixes)
}
...
func (t _ListParametersResultTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.StringSequenceToGo(&m.Prefixes, *(*primitives.CStringSequence)(unsafe.Pointer(&mem.prefixes)))
}
