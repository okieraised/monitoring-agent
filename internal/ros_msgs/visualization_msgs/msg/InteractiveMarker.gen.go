...
// InteractiveMarker
func NewInteractiveMarkerPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*InteractiveMarkerPublisher, error) {
...
// InteractiveMarker
func NewInteractiveMarkerSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback InteractiveMarkerSubscriptionCallback) (*InteractiveMarkerSubscription, error) {
