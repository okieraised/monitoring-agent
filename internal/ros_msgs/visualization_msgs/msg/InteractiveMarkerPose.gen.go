...
func NewInteractiveMarkerPosePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*InteractiveMarkerPosePublisher, error) {
...
// InteractiveMarkerPose
func NewInteractiveMarkerPoseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback InteractiveMarkerPoseSubscriptionCallback) (*InteractiveMarkerPoseSubscription, error) {
