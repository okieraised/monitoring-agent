...
// MeshFile
func NewMeshFilePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MeshFilePublisher, error) {
...
// MeshFile
func NewMeshFileSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MeshFileSubscriptionCallback) (*MeshFileSubscription, error) {
