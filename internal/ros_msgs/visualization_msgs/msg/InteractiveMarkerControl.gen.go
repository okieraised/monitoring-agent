...
func NewInteractiveMarkerControlPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*InteractiveMarkerControlPublisher, error) {
...
// InteractiveMarkerControl
func NewInteractiveMarkerControlSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback InteractiveMarkerControlSubscriptionCallback) (*InteractiveMarkerControlSubscription, error) {
