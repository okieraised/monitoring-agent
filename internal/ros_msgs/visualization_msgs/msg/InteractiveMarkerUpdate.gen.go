...
func NewInteractiveMarkerUpdatePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*InteractiveMarkerUpdatePublisher, error) {
...
// InteractiveMarkerUpdate
func NewInteractiveMarkerUpdateSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback InteractiveMarkerUpdateSubscriptionCallback) (*InteractiveMarkerUpdateSubscription, error) {
...
func (t _InteractiveMarkerUpdateTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.StringSequenceToC((*primitives.CStringSequence)(unsafe.Pointer(&mem.erases)), m.Erases)
}
...
func (t _InteractiveMarkerUpdateTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	primitives.StringSequenceToGo(&m.Erases, *(*primitives.CStringSequence)(unsafe.Pointer(&mem.erases)))
}
