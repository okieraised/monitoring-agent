...
func NewInteractiveMarkerFeedbackPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*InteractiveMarkerFeedbackPublisher, error) {
...
// InteractiveMarkerFeedback
func NewInteractiveMarkerFeedbackSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback InteractiveMarkerFeedbackSubscriptionCallback) (*InteractiveMarkerFeedbackSubscription, error) {
