...
// MarkerArray
func NewMarkerArrayPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*MarkerArrayPublisher, error) {
...
// MarkerArray
func NewMarkerArraySubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback MarkerArraySubscriptionCallback) (*MarkerArraySubscription, error) {
