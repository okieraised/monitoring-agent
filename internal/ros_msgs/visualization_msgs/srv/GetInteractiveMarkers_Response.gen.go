...
import (
	...
	visualization_msgs_msg "github.com/okieraised/monitoring-agent/internal/ros_msgs/visualization_msgs/msg"
...
func NewGetInteractiveMarkers_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*GetInteractiveMarkers_ResponsePublisher, error) {
	pub, err := node.NewPublisher(topicName, GetInteractiveMarkers_ResponseTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// GetInteractiveMarkers_Response
func NewGetInteractiveMarkers_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback GetInteractiveMarkers_ResponseSubscriptionCallback) (*GetInteractiveMarkers_ResponseSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg GetInteractiveMarkers_Response
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, GetInteractiveMarkers_ResponseTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (t _GetInteractiveMarkers_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	visualization_msgs_msg.InteractiveMarkerSequenceToC((*visualization_msgs_msg.CInteractiveMarkerSequence)(unsafe.Pointer(&mem.markers)), m.Markers)
}
...
func (t _GetInteractiveMarkers_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	...
	visualization_msgs_msg.InteractiveMarkerSequenceToGo(&m.Markers, *(*visualization_msgs_msg.CInteractiveMarkerSequence)(unsafe.Pointer(&mem.markers)))
}
...
type CGetInteractiveMarkers_ResponseSequence = C.visualization_msgs__srv__GetInteractiveMarkers_Response__Sequence

func GetInteractiveMarkers_ResponseSequenceToGo(goSlice *[]GetInteractiveMarkers_Response, cSlice CGetInteractiveMarkers_ResponseSequence) {
	if cSlice.size == 0 {
		return
	}
...
func GetInteractiveMarkers_ResponseSequenceToC(cSlice *CGetInteractiveMarkers_ResponseSequence, goSlice []GetInteractiveMarkers_Response) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func GetInteractiveMarkers_ResponseArrayToGo(goSlice []GetInteractiveMarkers_Response, cSlice []CGetInteractiveMarkers_Response) {
	for i := 0; i < len(cSlice); i++ {
		GetInteractiveMarkers_ResponseTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func GetInteractiveMarkers_ResponseArrayToC(cSlice []CGetInteractiveMarkers_Response, goSlice []GetInteractiveMarkers_Response) {
