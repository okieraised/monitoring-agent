...
// FrameGraph_Response
func NewFrameGraph_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*FrameGraph_ResponsePublisher, error) {
...
// FrameGraph_Response
func NewFrameGraph_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback FrameGraph_ResponseSubscriptionCallback) (*FrameGraph_ResponseSubscription, error) {
