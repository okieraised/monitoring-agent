...
// TFMessage
func NewTFMessagePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TFMessagePublisher, error) {
...
// TFMessage
func NewTFMessageSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TFMessageSubscriptionCallback) (*TFMessageSubscription, error) {
