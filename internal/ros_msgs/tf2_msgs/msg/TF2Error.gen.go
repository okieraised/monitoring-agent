...
// TF2Error
func NewTF2ErrorPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*TF2ErrorPublisher, error) {
...
// TF2Error
func NewTF2ErrorSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback TF2ErrorSubscriptionCallback) (*TF2ErrorSubscription, error) {
