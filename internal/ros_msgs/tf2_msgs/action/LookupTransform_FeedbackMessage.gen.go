...
type LookupTransform_FeedbackMessage struct {
	...
	Feedback LookupTransform_Feedback `yaml:"feedback"`
}
...
func NewLookupTransform_FeedbackMessagePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LookupTransform_FeedbackMessagePublisher, error) {
	pub, err := node.NewPublisher(topicName, LookupTransform_FeedbackMessageTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// LookupTransform_FeedbackMessage
func NewLookupTransform_FeedbackMessageSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LookupTransform_FeedbackMessageSubscriptionCallback) (*LookupTransform_FeedbackMessageSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg LookupTransform_FeedbackMessage
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, LookupTransform_FeedbackMessageTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
type CLookupTransform_FeedbackMessageSequence = C.tf2_msgs__action__LookupTransform_FeedbackMessage__Sequence

func LookupTransform_FeedbackMessageSequenceToGo(goSlice *[]LookupTransform_FeedbackMessage, cSlice CLookupTransform_FeedbackMessageSequence) {
	if cSlice.size == 0 {
		return
	}
...
func LookupTransform_FeedbackMessageSequenceToC(cSlice *CLookupTransform_FeedbackMessageSequence, goSlice []LookupTransform_FeedbackMessage) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func LookupTransform_FeedbackMessageArrayToGo(goSlice []LookupTransform_FeedbackMessage, cSlice []CLookupTransform_FeedbackMessage) {
	for i := 0; i < len(cSlice); i++ {
		LookupTransform_FeedbackMessageTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func LookupTransform_FeedbackMessageArrayToC(cSlice []CLookupTransform_FeedbackMessage, goSlice []LookupTransform_FeedbackMessage) {
