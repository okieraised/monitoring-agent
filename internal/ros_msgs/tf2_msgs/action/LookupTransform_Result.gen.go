...
func NewLookupTransform_ResultPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LookupTransform_ResultPublisher, error) {
...
// LookupTransform_Result
func NewLookupTransform_ResultSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LookupTransform_ResultSubscriptionCallback) (*LookupTransform_ResultSubscription, error) {
