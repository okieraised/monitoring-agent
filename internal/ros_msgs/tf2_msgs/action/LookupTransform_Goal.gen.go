...
func NewLookupTransform_GoalPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*LookupTransform_GoalPublisher, error) {
...
// LookupTransform_Goal
func NewLookupTransform_GoalSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback LookupTransform_GoalSubscriptionCallback) (*LookupTransform_GoalSubscription, error) {
