...
// WriteSplitEvent
func NewWriteSplitEventPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*WriteSplitEventPublisher, error) {
...
// WriteSplitEvent
func NewWriteSplitEventSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback WriteSplitEventSubscriptionCallback) (*WriteSplitEventSubscription, error) {
