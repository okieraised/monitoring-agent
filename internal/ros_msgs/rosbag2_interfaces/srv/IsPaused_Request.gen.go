...
// IsPaused_Request
func NewIsPaused_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*IsPaused_RequestPublisher, error) {
...
// IsPaused_Request
func NewIsPaused_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback IsPaused_RequestSubscriptionCallback) (*IsPaused_RequestSubscription, error) {
