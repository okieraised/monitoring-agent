...
type Burst_Request struct {
	NumMessages uint64 `yaml:"num_messages"` // Number of messages to burst; zero to burst the whole bag
}
...
// Burst_Request
func NewBurst_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Burst_RequestPublisher, error) {
...
// Burst_Request
func NewBurst_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Burst_RequestSubscriptionCallback) (*Burst_RequestSubscription, error) {
