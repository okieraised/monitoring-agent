...
func init() {
	<no value>.RegisterService("rosbag2_interfaces/Pause", PauseTypeSupport)
	<no value>.RegisterService("rosbag2_interfaces/srv/Pause", PauseTypeSupport)
}

type _PauseTypeSupport struct {}

func (s _PauseTypeSupport) Request() <no value>.MessageTypeSupport {
	return Pause_RequestTypeSupport
}

func (s _PauseTypeSupport) Response() <no value>.MessageTypeSupport {
...
var PauseTypeSupport <no value>.ServiceTypeSupport = _PauseTypeSupport{}

// PauseClient wraps <no value>.Client to provide type safe helper
// functions
...
// Pause
func NewPauseClient(node *<no value>.Node, serviceName string, options *<no value>.ClientOptions) (*PauseClient, error) {
...
func (s *PauseClient) Send(ctx context.Context, req *Pause_Request) (*Pause_Response, *<no value>.ServiceInfo, error) {
...
type PauseServiceRequestHandler func(*<no value>.ServiceInfo, *Pause_Request, PauseServiceResponseSender)

// PauseService wraps <no value>.Service to provide type safe helper
// functions
...
// Pause
func NewPauseService(node *<no value>.Node, name string, options *<no value>.ServiceOptions, handler PauseServiceRequestHandler) (*PauseService, error) {
