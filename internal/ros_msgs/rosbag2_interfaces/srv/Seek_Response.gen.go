...
// Seek_Response
func NewSeek_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Seek_ResponsePublisher, error) {
...
// Seek_Response
func NewSeek_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Seek_ResponseSubscriptionCallback) (*Seek_ResponseSubscription, error) {
