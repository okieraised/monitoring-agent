...
func init() {
	<no value>.RegisterService("rosbag2_interfaces/Resume", ResumeTypeSupport)
	<no value>.RegisterService("rosbag2_interfaces/srv/Resume", ResumeTypeSupport)
}

type _ResumeTypeSupport struct {}

func (s _ResumeTypeSupport) Request() <no value>.MessageTypeSupport {
	return Resume_RequestTypeSupport
}

func (s _ResumeTypeSupport) Response() <no value>.MessageTypeSupport {
...
var ResumeTypeSupport <no value>.ServiceTypeSupport = _ResumeTypeSupport{}

// ResumeClient wraps <no value>.Client to provide type safe helper
// functions
...
// Resume
func NewResumeClient(node *<no value>.Node, serviceName string, options *<no value>.ClientOptions) (*ResumeClient, error) {
...
func (s *ResumeClient) Send(ctx context.Context, req *Resume_Request) (*Resume_Response, *<no value>.ServiceInfo, error) {
...
type ResumeServiceRequestHandler func(*<no value>.ServiceInfo, *Resume_Request, ResumeServiceResponseSender)

// ResumeService wraps <no value>.Service to provide type safe helper
// functions
...
// Resume
func NewResumeService(node *<no value>.Node, name string, options *<no value>.ServiceOptions, handler ResumeServiceRequestHandler) (*ResumeService, error) {
