...
// Pause_Response
func NewPause_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Pause_ResponsePublisher, error) {
...
// Pause_Response
func NewPause_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Pause_ResponseSubscriptionCallback) (*Pause_ResponseSubscription, error) {
