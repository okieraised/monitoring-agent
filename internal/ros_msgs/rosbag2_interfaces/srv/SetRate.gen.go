...
func init() {
	<no value>.RegisterService("rosbag2_interfaces/SetRate", SetRateTypeSupport)
	<no value>.RegisterService("rosbag2_interfaces/srv/SetRate", SetRateTypeSupport)
}

type _SetRateTypeSupport struct {}

func (s _SetRateTypeSupport) Request() <no value>.MessageTypeSupport {
	return SetRate_RequestTypeSupport
}

func (s _SetRateTypeSupport) Response() <no value>.MessageTypeSupport {
...
var SetRateTypeSupport <no value>.ServiceTypeSupport = _SetRateTypeSupport{}

// SetRateClient wraps <no value>.Client to provide type safe helper
// functions
...
// SetRate
func NewSetRateClient(node *<no value>.Node, serviceName string, options *<no value>.ClientOptions) (*SetRateClient, error) {
...
func (s *SetRateClient) Send(ctx context.Context, req *SetRate_Request) (*SetRate_Response, *<no value>.ServiceInfo, error) {
...
type SetRateServiceRequestHandler func(*<no value>.ServiceInfo, *SetRate_Request, SetRateServiceResponseSender)

// SetRateService wraps <no value>.Service to provide type safe helper
// functions
...
// SetRate
func NewSetRateService(node *<no value>.Node, name string, options *<no value>.ServiceOptions, handler SetRateServiceRequestHandler) (*SetRateService, error) {
