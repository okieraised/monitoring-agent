...
// Burst_Response
func NewBurst_ResponsePublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Burst_ResponsePublisher, error) {
...
// Burst_Response
func NewBurst_ResponseSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Burst_ResponseSubscriptionCallback) (*Burst_ResponseSubscription, error) {
