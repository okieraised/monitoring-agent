...
// Seek_Request
func NewSeek_RequestPublisher(node *rclgo.Node, topicName string, options *rclgo.PublisherOptions) (*Seek_RequestPublisher, error) {
...
// Seek_Request
func NewSeek_RequestSubscription(node *rclgo.Node, topicName string, opts *rclgo.SubscriptionOptions, subscriptionCallback Seek_RequestSubscriptionCallback) (*Seek_RequestSubscription, error) {
